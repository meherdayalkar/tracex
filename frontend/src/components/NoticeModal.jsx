...
export default function NoticeModal({ scan, isOpen, onClose, onNoticeSent }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white border border-slate-300 rounded-2xl max-w-xl w-full shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="bg-[#0F172A] text-white px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold tracking-tight">Issue Formal Statutory Notice (Section 36)</h3>
              <p className="text-[11px] text-slate-400">Tamper-evident RSA-2048 Signed Legal Notice</p>
            </div>
          </div>
          <button 
            onClick={onClose} 
          ...
          <form onSubmit={handleSend} className="p-6 space-y-4">
            ...
            <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-semibold bg-[#0F172A] text-white hover:bg-slate-800 transition-colors shadow-sm disabled:opacity-60"
              >
                {submitting ? (
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="flex items-center justify-between pt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-medium border border-slate-300 bg-white text-slate-800 hover:bg-slate-50 transition-colors"
              >
              ...
              <button
                onClick={onClose}
                className="px-4 py-2 rounded-lg text-xs font-semibold bg-[#0F172A] text-white hover:bg-slate-800 transition-colors"
              >
                Done
              </button>
            </div>
