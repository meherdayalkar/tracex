...
export default function InspectorView() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-65px)] bg-[#F8F9FB]">
      {/* Persistent Left Sidebar Navigation */}
      <aside className="w-64 bg-[#0F172A] text-slate-300 border-r border-slate-800 flex flex-col shrink-0">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        {activeTab === 'scan' && (
          <div className="p-6 max-w-6xl mx-auto space-y-6">
            ...
            {currentScan && (
              <div className="flex items-center justify-between bg-slate-100/90 border border-slate-300 px-4 py-2.5 rounded-xl text-xs">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-3 mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 border border-slate-300 bg-white text-xs font-semibold text-slate-700 hover:bg-slate-50 rounded-lg shadow-2xs transition-colors"
                      >
                      ...
                      {!currentScan.is_compliant && (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-red-700 hover:bg-red-800 text-white text-xs font-semibold rounded-lg shadow-xs transition-colors"
                        >
